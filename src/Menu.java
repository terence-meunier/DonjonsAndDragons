...
public class Menu {
    ...
    // Objet Scanner pour r�cup�rer les entr�es du clavier
    ...
    private static int mainMenu() {
        ...
        if (character != null) {
            System.out.println("	3 : Afficher " + character.getName());
    ...
    private static void characterMenu() {
        ...
        if (character != null) {
            ...
            while (choice != 3) {
                System.out.println("-------------------------------------------");
                System.out.println("--- Menu Guerrier " + character.getName() + " ---");
                System.out.println("-------------------------------------------");
                System.out.println();
